...
$TEMPLATE_LIST_NEW['PAGE_RECENT'] = "
  <div class='list-new-item' style='padding: 5px;'>
    <i class='fa fa-plus-square-o'></i>{LIST_ICON} {LIST_DATE} {LIST_HEADING} {LIST_AUTHOR} {LIST_CATEGORY} {LIST_INFO}
  </div>";
...
$TEMPLATE_LIST_NEW['COL_WELCOME'] = "
      <td colspan='{LIST_COL_COLS}' class='forumheader3'>{LIST_COL_WELCOMETEXT}<br /><br /></td>";
...
$TEMPLATE_LIST_NEW['COL_CELL_START'] = "
      <td style='width:{LIST_COL_CELLWIDTH}%; padding-right:5px; vertical-align:top;'>";
