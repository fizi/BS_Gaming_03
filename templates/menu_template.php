...
#### Additional control over image thumbnailing is possible via SETIMAGE e.g. {SETIMAGE: w=200&h=150&crop=1}
	...
	$MENU_TEMPLATE['grid']['start'] = '
  <div class="home-chapter-box">                             
    <div class="home-chapter-box-title">             		                                                      
      <h2>{CHAPTER_TITLE}</h2>
    </div>
    <div class="home-chapter-box-body">
      <div class="row">
  ';
  
	$MENU_TEMPLATE['grid']['body'] = '
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="chapter-item">
            <div class="chapter-item-image">
              {SETIMAGE: w=1000&h=750&crop=1}
              <a href="{CMENUURL}">{CMENUIMAGE}</a>
            </div>
            <h4 class="chapter-item-title"><a href="{CMENUURL}">{CMENUTITLE}</a></h4>
            <div class="chapter-item-body">{CMENUBODY: limit=60}</div>
            <div class="chapter-item-button">{CPAGEBUTTON}</div>
          </div>
        </div>
  ';
	$MENU_TEMPLATE['grid']['end'] = '
      </div>
    </div>
  </div>';
?>