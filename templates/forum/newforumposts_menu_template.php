...
<ul class='media-list newforumposts-menu unstyled list-unstyled'>
{SETIMAGE: w=48&h=48&crop=1}";

$NEWFORUMPOSTS_MENU_TEMPLATE['default']['item'] = "
  <li class='media'>
	  <span class='media-object pull-left'>
		  {POST_AUTHOR_AVATAR: shape=circle}
		</span>
    <div class='media-body'>
		  <h4 class='media-header'><a href='{POST_URL}'>{POST_TOPIC}</a></h4>
      {POST_CONTENT}<br />
      <small class='text-muted muted'>".LAN_FORUM_MENU_001." {POSTER} {POST_DATESTAMP}</small>
		</div>
  </li>";
