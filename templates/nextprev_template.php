...
$NEXTPREV_TEMPLATE['bootstrap_nav_first'] = '<li><a class="first hidden-xs" href="{url}" title="{url_label}"><i class="fa fa-fast-backward"></i></a></li>';
$NEXTPREV_TEMPLATE['bootstrap_nav_prev'] = '<li><a class="prev" href="{url}" title="{url_label}"><i class="fa fa-long-arrow-left"></i></a></li>';
$NEXTPREV_TEMPLATE['bootstrap_nav_last'] = '<li><a class="last hidden-xs" href="{url}" title="{url_label}"><i class="fa fa-fast-forward"></i></a></li>';
$NEXTPREV_TEMPLATE['bootstrap_nav_next'] = '<li><a class="next" href="{url}" title="{url_label}"><i class="fa fa-long-arrow-right"></i></a></li>';
