...
{SETIMAGE: w=2205&h=510&crop=1}
<div class="{FEATUREBOX_ACTIVE} item slide{FEATUREBOX_COUNTER}">
	{FEATUREBOX_IMAGE}		
  <div class="row">
    <div class="carousel-caption">
      <h1 class="featurebox-item-title">{FEATUREBOX_TITLE}</h1>
      <div class="featurebox-item-body">{FEATUREBOX_TEXT}</div>
    </div>
  </div>
</div>';
...
<div class="{FEATUREBOX_ACTIVE} item slide{FEATUREBOX_COUNTER}">
  <div class="row">
    <div class="col-md-6">
      <div class="featurebox-item-image">
        {FEATUREBOX_IMAGE=placeholder}
      </div>
    </div>
    <div class="col-md-6">
      <div class="featurebox-item-text">
        <h1 class="featurebox-item-title">{FEATUREBOX_TITLE}</h1>
        <div class="featurebox-item-body">{FEATUREBOX_TEXT}</div>
			  <div class="featurebox-item-button">{FEATUREBOX_BUTTON}</div>
      </div>
		</div>
  </div>
</div>
...
<div class="featurebox-item">
  ...
  <h3>{FEATUREBOX_TITLE|image_left}</h3>
...
<div class="featurebox-item">
  ...
  <h3>{FEATUREBOX_TITLE|image_right}</h3>
